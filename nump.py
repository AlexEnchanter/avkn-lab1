...
mean = [np.mean(data[i], axis=0) for i in range(len(data[i]))]
percentile_95 = [np.percentile(data,95, axis=0) for i in range(len(data[i]))]
percentile_99 = [np.percentile(data,99, axis=0) for i in range(len(data[i]))]
